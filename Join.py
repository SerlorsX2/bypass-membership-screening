    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print('Join the server successfully')
            except:
                pass
    except:
        print("You have already joined this server")

if __name__ == "__main__":
    accountToken = input("Dicord Account Token : ")
    discordServerId = input("Server ID (TO JOIN) : ")
